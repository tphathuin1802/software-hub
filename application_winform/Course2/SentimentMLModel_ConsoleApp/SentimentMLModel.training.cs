...
namespace SentimentMLModel_ConsoleApp
{
    public partial class SentimentMLModel
    {
        public const string RetrainFilePath =  @"C:\DevProjects\01_Resources\Dataset\sentiment labelled sentences\sentiment labelled sentences\amazon_cells_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.15976413F,L2Regularization=0.03125F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
